  ...
  <div v-for="(value,index) in arr" class="leveList clear" :id="index" >
    ...
    <div class="projectList clear" >
      ...
      <p class="projectP" v-for="value2 in value.content">
        ...
        <!-- 图片 -->
        <span class="videoList" @click="myVideo(value2.aid,value2.astatus)" v-if="value2.astatus == '0'"><img src="../../../static/bgimg/shipin.png" alt=""></span>
        <span class="videoList" @click="myVideo(value2.aid,value2.astatus)" v-if="value2.astatus == '1'"><img src="../../../static/bgimg/shipin2.png" alt=""></span>
...
export default {
  ...
  created:function () {
    ...
    this.$http.get(process,{params:{"memberId":userid,"type":0},headers:{
...
.projectList .projectP:first-of-type{
  /*margin-top: 0.8rem;*/
}
