...
AJAX('GET',storage,REYURNURL(BANCOACH),{"regionId":"","serviceType":0},bancoachList);

// 雪区改变
$('.qu').change(function () {
    var regionId = $(this).val();
    AJAX('GET',storage,REYURNURL(BANCOACH),{"regionId":regionId,"serviceType":0},bancoachList);
});
...
$('.delet').on('click',function () {
    ...
    if(con == true){
      AJAX('POST',storage,REYURNURL(DELTEBANCOACH),{"coachId":coachId,"type":0},deleteCoach);
    }
})
